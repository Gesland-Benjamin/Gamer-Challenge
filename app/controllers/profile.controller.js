...
// ProfileController handles user profile and their challenges listing
class ProfileController extends CoreController {
    // List challenges for the currently logged-in user
    ...
    // List challenges for a specific user by their ID
